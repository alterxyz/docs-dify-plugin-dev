...
2. 根据[插件隐私数据保护指南](/plugin_dev_zh/0312-privacy-protection-guidelines.zh)撰写该插件隐私政策，并将该隐私政策的文件路径或 URL 写入插件[清单文件](/plugin_dev_zh/0411-plugin-info-by-manifest.zh)；
3. 完成插件打包；
...
* 检查插件的 [Manifest 文件](/plugin_dev_zh/0411-plugin-info-by-manifest.zh)是否符合格式规范，并包含有效的作者联系信息。
...
- [通过清单文件定义插件信息](/plugin_dev_zh/0411-plugin-info-by-manifest.zh) - 插件元数据定义
