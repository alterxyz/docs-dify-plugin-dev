...
> 了解更多：[初始化开发工具](/plugin_dev_zh/0221-initialize-development-tools)
...
> 了解更多：[Dify 插件开发：Hello World 指南](/plugin_dev_zh/0211-getting-started-dify-tool)
...
> 了解更多：[远程调试插件](/plugin_dev_zh/0411-remote-debug-a-plugin)
...
> 了解更多：[发布概览](/plugin_dev_zh/0321-release-overview)、[发布到 Dify 市场](/plugin_dev_zh/0322-release-to-dify-marketplace)
...
- **工具插件**: 集成第三方 API 和服务
  > 了解更多：[工具插件开发](/plugin_dev_zh/0211-getting-started-dify-tool)
- **模型插件**: 集成 AI 模型
  > 了解更多：[模型插件介绍](/plugin_dev_zh/0131-model-plugin-introduction)、[快速接入一个新模型](/plugin_dev_zh/0211-getting-started-new-model)
- **Agent 策略插件**: 自定义 Agent 思考和决策策略
  > 了解更多：[Agent 策略插件](/plugin_dev_zh/9433-agent-strategy-plugin)
- **扩展插件**: 扩展 Dify 平台功能，例如 Endpoint 和 WebAPP
  > 了解更多：[扩展插件](/plugin_dev_zh/9231-extension-plugin)
...
> 了解更多：[工具插件](/plugin_dev_zh/0222-tool-plugin)
...
> 了解更多：[通过清单文件定义插件信息](/plugin_dev_zh/0411-plugin-info-by-manifest)
...
> 了解更多常见问题解答：[常见问题解答](/plugin_dev_zh/0331-faq)
...
- [模型插件介绍](/plugin_dev_zh/0131-model-plugin-introduction)
- [插件发布概览](/plugin_dev_zh/0321-release-overview)
- [常见问题解答](/plugin_dev_zh/0331-faq)
- [通用规范](/plugin_dev_zh/0411-general-specifications)
- [插件开发入门](/plugin_dev_zh/0111-getting-started-dify-plugin)