...
此处已省去 `manifest` 文件内部分无关的字段。如需了解 Manifest 的详细格式，请参考 [通过清单文件定义插件信息](/plugin_dev_zh/0411-plugin-info-by-manifest) 文档。
...
- [Agent 策略插件开发示例](/plugin_dev_zh/9433-agent-strategy-plugin) - 实际的 Agent 策略插件开发示例
- [通过清单文件定义插件信息](/plugin_dev_zh/0411-plugin-info-by-manifest) - 了解 Manifest 文件的详细格式
