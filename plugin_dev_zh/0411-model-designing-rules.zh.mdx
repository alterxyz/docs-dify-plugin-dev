...
> 关于模板的具体使用，可以参考[创建新模型提供者](/plugin_dev_zh/0222-creating-new-model-provider)中的示例。
...
- [模型架构详解](/plugin_dev_zh/0412-model-schema) - 深入了解模型插件的架构规范
- [快速接入一个新模型](/plugin_dev_zh/0211-getting-started-new-model) - 学习如何应用这些规则添加新模型
- [通过清单文件定义插件信息](/plugin_dev_zh/0411-plugin-info-by-manifest) - 了解插件清单文件的配置
- [创建新模型提供者](/plugin_dev_zh/0222-creating-new-model-provider) - 开发全新的模型提供商插件