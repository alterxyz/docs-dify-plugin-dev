...
summary: This document introduces the concept and development methods of Bundle plugin packages. Bundle plugin packages can combine multiple plugins together, supporting three types (Marketplace type, GitHub type, and Package type). The document details the complete process of creating Bundle projects, adding different types of dependencies, and packaging Bundle projects.
original_en: true
---
