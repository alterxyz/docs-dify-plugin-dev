...
summary: This document provides detailed guidance on how to create a model provider plugin, including project initialization, choosing model configuration methods (predefined vs. custom models), creating the provider configuration YAML file, and writing the provider code.
---
