...
summary: This document is for developers who need to write Python code to add or enhance Dify's model support. It provides detailed guidance on the complete process of creating directory structures, writing model configurations, implementing model invocation logic, debugging, and publishing plugins, including details on core method implementation and error handling.
---
