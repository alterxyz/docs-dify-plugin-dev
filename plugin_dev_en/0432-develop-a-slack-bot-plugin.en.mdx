...
description: This guide provides a complete walkthrough for developing a Slack Bot
  plugin, covering everything from project initialization, configuration form editing,
  implementing functional code, plugin debugging, setting up endpoints, verification,
  to packaging and publishing. You'll need the Dify plugin development tool and a
  created Slack App to build an AI-powered chatbot on the Slack platform.
---
