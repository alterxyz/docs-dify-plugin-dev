...
original_en: true
description: This document details how to integrate custom models in Dify, using Xinference
  as an example. It covers creating model provider files, writing corresponding code
  based on model types, implementing model invocation logic, exception handling, debugging,
  and deployment processes. It specifically explains the implementation of core methods
  such as LLM calls, token calculation, credential verification, and parameter generation.
---
