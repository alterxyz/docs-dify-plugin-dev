...
description: Introduces the concept, features, and development value of Dify plugins,
  including a brief description of plugin types (Models, Tools, Agent Strategies,
  Extensions, Bundles), and an overview of the developer documentation content.
---
