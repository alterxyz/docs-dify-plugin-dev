...
language: en
title: Agent
summary: This document details the development process of Dify's Agent strategy plugins, including adding Agent strategy fields in the Manifest file, defining Agent providers, and implementing core steps for Agent strategies. The document provides complete example code for parameter retrieval, model invocation, tool calling, and log generation and management.
original_en: true
---
