...
summary: This document defines the core concepts and structures for Dify model plugin development in detail, including Model Provider (Provider), AI Model Entity (AIModelEntity), Model Type (ModelType), Configuration Method (ConfigurateMethod), Model Feature (ModelFeature), Parameter Rule (ParameterRule), Price Configuration (PriceConfig), and detailed data structure specifications for various credential modes.
---
