...
language: en
title: Endpoint
summary: Author: Yeuoly，Allen This document details the structure and implementation of Endpoints in Dify plugins, using the Rainbow Cat project as an example. It covers how to define Endpoint groups, configure interfaces, implement the _invoke method, and handle requests and responses. The document explains in detail the meaning and usage of various YAML configuration fields.
original_en: true
---
