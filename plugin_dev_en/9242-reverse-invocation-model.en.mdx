...
title: Model
original_en: true
description: This document details how plugins can reverse invoke model services in
  the Dify platform. It covers specific methods for reverse invoking LLM, Summary,
  TextEmbedding, Rerank, TTS, Speech2Text, and Moderation models, with corresponding
  entry points, interface parameter descriptions, and practical example code for each
