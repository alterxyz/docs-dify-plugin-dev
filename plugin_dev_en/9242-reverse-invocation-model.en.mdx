...
language: en
title: Model
summary: This document details how plugins can reverse invoke model services in the Dify platform. It covers specific methods for reverse invoking LLM, Summary, TextEmbedding, Rerank, TTS, Speech2Text, and Moderation models, with corresponding entry points, interface parameter descriptions, and practical example code for each model invocation, along with best practices for model invocation.
original_en: true
---
