...
summary: This document provides a complete tutorial on developing Extension type plugins, covering environment preparation, project creation, defining plugin request endpoints, writing functional code, debugging, packaging, and publishing. The example project is a rainbow cat plugin that demonstrates how to handle HTTP requests and provide web services through Extension plugins.
original_en: true
---
