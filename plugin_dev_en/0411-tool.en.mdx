...
title: Tool Return
original_en: true
description: This document details the data structures and usage methods for Tools
  in Dify plugins. It covers how to return different types of messages (image URLs,
  links, text, files, JSON), how to create variable and streaming variable messages,
  and how to define the output variable schema for tools to facilitate referencing
  in workflows.
---
