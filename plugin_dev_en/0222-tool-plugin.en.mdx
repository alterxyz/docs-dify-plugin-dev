...
language: en
title: Tool Plugins
summary: This document details how to develop Dify tool plugins, using Google Search as an example to implement a complete tool plugin development process. It covers plugin initialization, template selection, tool provider configuration file definition, adding third-party service credentials, tool function code implementation, debugging, and packaging/publishing.
---
