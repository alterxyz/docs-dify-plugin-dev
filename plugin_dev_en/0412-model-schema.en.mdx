...
original_en: true
description: This document details the interface specifications required for Dify
  model plugin development, including implementation for model providers, interface
  ...
  LLMResult. The document serves as a development reference for developers integrating
  various models.
---
