...
language: en
title: App
summary: This document details how plugins can reverse invoke App services in the Dify platform. It covers three different types of interfaces: Chat interface (for Chatbot/Agent/Chatflow type applications), Workflow interface, and Completion interface, providing entry points, calling specifications, and actual code examples for each interface type.
original_en: true
---
