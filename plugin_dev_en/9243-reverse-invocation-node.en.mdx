...
language: en
title: Node
summary: This document describes how plugins can reverse invoke Chatflow/Workflow application node functions in the Dify platform. The content mainly covers the invocation methods of two special nodes: Parameter Extractor node (ParameterExtractor) and Question Classifier node (QuestionClassifier). The document details the entry points, interface parameters, and example code for these two nodes.
original_en: true
---
