...
description: This document details how to develop an Agent strategy plugin, covering
  the entire process from initializing plugin templates to calling models, using tools,
  outputting logs, and packaging for release. The documentation provides comprehensive
  code examples, including how to implement automated tool calling functionality to
  help LLM perform reasoning or decision logic.
---
