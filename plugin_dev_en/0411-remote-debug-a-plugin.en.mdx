...
description: This document introduces how to use Dify's remote debugging feature to
  test plugins. It details the complete process of obtaining debugging information,
  configuring environment variable files, starting remote plugin debugging, and verifying
  the plugin installation status. This allows developers to test plugins in the Dify
  environment in real-time while developing locally.
---
