...
summary: This document guides non-professional developers on how to add new models to Dify, focusing on adding new model variants to existing providers by modifying configuration files. It covers the complete process from forking the repository to copying and modifying model configurations, updating provider versions, local testing, and submitting contributions.
---
