...
PWX_TO_GROUP_MAP = {
    ...
    ('0', '2', '2'): ("插件开发", "开发实践", "标准开发流程"),
    #   Group: 贡献与发布
    ('0', '3', '1'): ("插件开发", "贡献与发布", "行为准则与规范"),
    ('0', '3', '2'): ("插件开发", "贡献与发布", "发布插件"),
    ('0', '3', '3'): ("插件开发", "贡献与发布", "常见问题解答"),
    #   Group: 实践案例与示例 (原 043x)
    ('0', '4', '3'): ("插件开发", "实践案例与示例", "开发示例"),          # <-- 保留在主流程
    #   Group: 高级开发技巧 (原 P=9 内容)
    ('9', '2', '2'): ("插件开发", "高级开发技巧", "高级插件与 Agent"),    # <-- P=9 内容整合进来
    ('9', '2', '3'): ("插件开发", "高级开发技巧", "高级插件与 Agent"),    # <-- P=9 内容整合进来
    ('9', '4', '3'): ("插件开发", "高级开发技巧", "高级插件与 Agent"),    # <-- P=9 内容整合进来
    ('9', '2', '4'): ("插件开发", "高级开发技巧", "反向调用实现"),         # <-- P=9 内容整合进来
